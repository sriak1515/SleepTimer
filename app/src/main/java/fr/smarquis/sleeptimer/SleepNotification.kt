...
object SleepNotification {
    ...
    private val TIMEOUT_INITIAL_MILLIS = MINUTES.toMillis(10)
    private val TIMEOUT_INCREMENT_MILLIS = MINUTES.toMillis(2)
    private val TIMEOUT_DECREMENT_MILLIS = MINUTES.toMillis(2)
